				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td>
							...
							<small>
								<?php echo sprintf( __( "This is the default version to use if one isn't specified.  It is usually safe to set this to the <a href='%s'>most recent version</a>.", 'paypal-yearly-subscription' ), 'https://developer.paypal.com/docs/classic/release-notes/' ); ?>
							</small>
						</td>
					</tr>
					<tr valign="top">
